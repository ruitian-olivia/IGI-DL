# Training Graph-based GAT model, with leave-one-patient-out validation to evaluate the performance
import os
import sys
import cv2
import json
...
from GNN_model import GAT_4layer
...
for run in range(runs):
    ...
    model = GAT_4layer(num_feature=num_feature, num_gene=num_gene, nhid=nhid).to(device)
