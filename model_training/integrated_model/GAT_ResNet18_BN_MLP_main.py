# Training Integrated GAT+ResNet18 model, with leave-one-patient validation to evaluate the performance
import os
import cv2
import json
import time
...
from GNN_CNN_fusion_model import GAT4layer_ResNet18
...
for run in range(runs):
    ...
    model = GAT4layer_ResNet18(85, num_gene, nhid, mlp_hidden).to(device)
