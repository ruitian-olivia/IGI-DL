# Training Integrated GCN+ResNet18 model, with leave-one-patient validation to evaluate the performance
import os
import cv2
import json
import time
...
from GNN_CNN_fusion_model import GCN4layer_ResNet18
from GNN_CNN_training_function import setup_seed, train, valid, test, cal_gene_pearson, mape, test_spatial_visual
...
for run in range(runs):
    ...
    model = GCN4layer_ResNet18(85, num_gene, nhid, mlp_hidden).to(device)
