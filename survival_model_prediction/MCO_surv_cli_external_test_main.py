...
import sys
import argparse
from MCO_surv_cli_external_test import External_test
import torch
...
def Parser_main():
    ...
    parser.add_argument("--model_weights_name", default="CRC_GAT_surv_cli_ALL", help="Model name", type=str)
