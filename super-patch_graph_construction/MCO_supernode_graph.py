...
superpatch_dir = './preprocessed_MCO/supernode_graph'
features_dir = './extract_patch_features/IGI_DL_MCO'
...
print("len(predict_gene_path):", len(predict_gene_path))
...
with open(high_gene_path, "r", encoding="utf-8") as f:
    high_gene_list = f.read().splitlines()
print("len(high_gene_list):", len(high_gene_list))
...
pool_obj = multiprocessing.Pool(192)
