...
# Load the gene names with high Pearson correlation in IGI_DL prediction in breast cancer
high_gene_path = './extract_patch_features/node_features_name/breast_gene_features.txt'
with open(predict_gene_path, "r", encoding="utf-8") as f:
