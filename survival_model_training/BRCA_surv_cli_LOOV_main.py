...
import sys
import argparse
from BRCA_surv_cli_LOOV import Train
import torch
...
def Parser_main():
    ...
    parser.add_argument("--node_feature_num", default=72, help="Number of node features in constructed Super-node Graph", type=int)
