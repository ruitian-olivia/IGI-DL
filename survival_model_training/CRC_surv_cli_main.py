...
import sys
import argparse
from CRC_surv_cli_train import Train
import torch
...
def Parser_main():
    ...
    parser.add_argument("--node_feature_num", default=53, help="Number of node features in constructed Super-node Graph", type=int)
