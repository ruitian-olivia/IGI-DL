...
class postprocess(torch.nn.Module):
    ...
    def __init__(self, graph_feature_dim, graph_layer_num, last_input_dim, post_layer_num, dropout_rate):
        ...
        poststartlayer = graph_feature_dim * graph_layer_num + last_input_dim # 50*2*3 +50*2=400 
        postlayerpreset = [int(poststartlayer / 4.0), # 100
                           int(poststartlayer / 8.0), # 50
                           int(poststartlayer / 16.0)] # 25
        self.postlayernum = []
